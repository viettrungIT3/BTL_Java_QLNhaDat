...
public class HomeTransactionFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbGDNha = new javax.swing.JTable();
        ...
        tbGDNha.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "STT", "Mã giao dịch", "Ngày giao dịch", "Ðơn giá", "Loại nhà", "Diện tích", "Thành tiền"
            }
        ) {
        ...
        tbGDNha.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbGDNhaMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tbGDNha);
        if (tbGDNha.getColumnModel().getColumnCount() > 0) {
            tbGDNha.getColumnModel().getColumn(0).setMinWidth(50);
            tbGDNha.getColumnModel().getColumn(0).setPreferredWidth(50);
            tbGDNha.getColumnModel().getColumn(0).setMaxWidth(50);
        }
        ...
        jLabel1.setText("Quản lý giao dịch nhà");
        ...
        jLabel7.setText("Loại nhà:");

        cbLoaiDat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "cao cấp", "thường" }));
    ...
    private void tbGDNhaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbGDNhaMouseClicked
        DefaultTableModel tableModel = (DefaultTableModel) tbGDNha.getModel();
        Vector<Object> v = (Vector<Object>) tableModel.getDataVector().elementAt(tbGDNha.getSelectedRow());

        Transaction t = HomeTransactionController.getTransactionByUser(idUser, v.get(1).toString());
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (txtMaDG.getText().trim().compareTo("") != 0) {
            JOptionPane.showConfirmDialog(null, " Bạn phải nhập mới", "Lỗi thêm gio dich nhà", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
...
//            Date ngay = sdf.format(jdcNgayGD.getDate());
        ...
        if (!HomeTransactionController.CreateNewTransaction(x)) {
            JOptionPane.showConfirmDialog(null, "Tạo giao dịch mới thất bại", "Lỗi thêm mới", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
            return;
        }
        JOptionPane.showConfirmDialog(null, "Tạo giao dịch mới thành công", "Thêm mới", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (responseConfirm == JOptionPane.YES_OPTION) {
            if (!HomeTransactionController.updateTransaction(x)) {
                JOptionPane.showConfirmDialog(null, "Sửa gio dich nhà thất bại", "Lỗi sửa giao dịch thất bại", JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
                return;
            }
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (responseConfirm == JOptionPane.YES_OPTION) {
            if (!HomeTransactionController.deleteTransaction(idUser, txtMaDG.getText())) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        List<Transaction> transactions = List.copyOf(HomeTransactionController.getAllTransactionByUser(idUser));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeTransactionFrame.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomeTransactionFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbGDNha;

...
public class TransactionController {
    ...
    public static List<Transaction> getAllTransactionByUserAndYear(String idUser, String year) {
        ...
        try {
            Connection conn = ConnectDB.getConnection();
            String sqlHome = "SELECT * FROM HOME_TRANSACTIONS where id='" + idUser + "' AND YEAR(t_date)='" + year + "' ORDER BY FORMAT(t_date, 'yyyy/MM/dd') DESC, t_id, t_type, t_price";
            String sqlland = "SELECT * FROM LAND_TRANSACTIONS where id='" + idUser + "' AND YEAR(t_date)='" + year + "' ORDER BY FORMAT(t_date, 'yyyy/MM/dd') DESC, t_id, t_type, t_price";
            Statement stm = conn.createStatement();
            ResultSet rs = stm.executeQuery(sqlHome);
            while (rs.next()) {
                Date day = rs.getDate("t_date");
    ...
    public static List<Transaction> getAllTransactionByUserAndMonthYear(String idUser, String year, String month) {
        ...
        try {
            Connection conn = ConnectDB.getConnection();
            String sqlHome = "SELECT * FROM HOME_TRANSACTIONS where id='" + idUser + "' AND YEAR(t_date)='" + year + "' and Month(t_date)='" + month + "'ORDER BY FORMAT(t_date, 'yyyy/MM/dd') DESC, t_id, t_type, t_price";
            String sqlland = "SELECT * FROM LAND_TRANSACTIONS where id='" + idUser + "' AND YEAR(t_date)='" + year + "' and Month(t_date)='" + month + "'ORDER BY FORMAT(t_date, 'yyyy/MM/dd') DESC, t_id, t_type, t_price";
            Statement stm = conn.createStatement();
            ResultSet rs = stm.executeQuery(sqlHome);
            while (rs.next()) {
                Date day = rs.getDate("t_date");
